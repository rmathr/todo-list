...
function controlDueDateChange(element, index, todos){
    ...
    function handleDateChange(){
        datePicker.addEventListener('selectDate', function(event) {
            console.log(event)
            const datepicked = event.detail
            ;(0,_todoCreator__WEBPACK_IMPORTED_MODULE_2__.modifyDueDate)(index, datepicked, todos)
            datePicker.remove()
...
/* harmony import */ var _right_png__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./right.png */ "./src/right.png");
/* harmony import */ var wc_datepicker_dist_components_wc_datepicker__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! wc-datepicker/dist/components/wc-datepicker */ "./node_modules/wc-datepicker/dist/components/wc-datepicker.js");
