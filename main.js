...
const todo1 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('walk with Manchinha', 'to-do', 'daily', 'high', '2023-04-03', todos)
// const todo1 = createNewTask('walk with Manchinha', 'to-do', 'daily', 'high', '04/03/2023', todos)
const todo2 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('play Ravendawn', 'to-do', 'daily', 'high', '2023-04-03', todos)
const todo3 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('study math', 'to-do', 'daily', 'medium', '2023-06-04', todos)
const todo4 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('play guitar', 'doing', 'general', 'low', '2023-07-02', todos)
const todo5 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('look for beavers', 'to-do', 'general', 'high', '2023-04-12', todos)
const todo6 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('try to catch a squirrel', 'to-do', 'general', 'low', '2023-12-06', todos)
const todo7 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('watch tv', 'doing', 'Nemo', 'medium', '2022-05-05', todos)
const todo8 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('take a shower', 'to-do', 'Project', 'high', '2024-05-17', todos)
const todo9 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('born', 'done', 'Nemo', 'high', '1993-01-04', todos)
const todo10 = (0,_todoCreator__WEBPACK_IMPORTED_MODULE_3__.createNewTask)('graduate at fanshawe', 'wont do', 'Project', 'medium', '2023-12-11', todos)
