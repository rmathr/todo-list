...
const createNewTask = (task, status, list, priority, dueDate) => {
    const todos = (0,_handleSaveLogic__WEBPACK_IMPORTED_MODULE_1__.getFromLocalStorage)()
    console.log(todos)
...
const addTasks = function(){
    ...
    const todos = (0,_handleSaveLogic__WEBPACK_IMPORTED_MODULE_15__.getFromLocalStorage)()
    ;(0,_displayTasks__WEBPACK_IMPORTED_MODULE_2__["default"])(todos)
    console.log(todos)
    // todos.push(todo)
